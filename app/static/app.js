...
async function renderKnowledgeBase(tab) {
  ...
  view.innerHTML = `
    <div class="section-header">
      ...
      computed directly from the extracted data (not generated by the model), so the numbers are exact.
      Natural-language Q&amp;A across the corpus is coming next.</p>
    </div>
    <div class="tabs">
      <button data-kbtab="insights">Insights</button>
      <button data-kbtab="ingest">Ingest treaties</button>
      <button data-kbtab="ask" disabled title="Coming next">Ask <span class="chip superseded">soon</span></button>
    </div>
